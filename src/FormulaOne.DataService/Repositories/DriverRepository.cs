...
namespace FormulaOne.DataService.Repositories
{
    public class DriverRepository : GenericRepository<Driver>, IDriverRepository
    {
        ...
        public override async Task<IEnumerable<Driver>> All()
        {
            ...
            {
                _logger.LogError(exception: ex, message: "{Repo} All function error", args: typeof(DriverRepository));
                throw;
            }
        }
        ...
        public override async Task<bool> Delete(Guid id)
        {
            ...
            {
                _logger.LogError(exception: ex, message: "{Repo} Delete function error", args: typeof(DriverRepository));
                throw;
            }
        }
        ...
        public override async Task<bool> Update(Driver driver)
        {
            ...
            {
                _logger.LogError(exception: ex, message: "{Repo} Update function error", args: typeof(DriverRepository));
                throw;
            }
        }
    }
